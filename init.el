...
(custom-set-faces
 ...
 '(company-tooltip-scrollbar-thumb ((t (:background "#222222"))))
 '(company-tooltip-scrollbar-track ((t (:background "#2f2f2f"))))
